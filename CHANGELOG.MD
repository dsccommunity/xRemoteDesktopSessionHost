...
- xRDSessionCollectionConfiguration
  - Fixed comparison of some RD Session Collection Configuration properties and
    supplied parameters by performing some normalization prior to the comparison.
