...
BeforeAll {
    ...
    $script:dscResourceName = 'DSC_RDConnectionBrokerHAMode'
...
Describe 'DSC_RDConnectionBrokerHAMode\Get-TargetResource' -Tag 'Get' {
...
Describe 'DSC_RDConnectionBrokerHAMode\Test-TargetResource' -Tag 'Test' {
    Context 'When the resource is in the desired state' {
        BeforeAll {
